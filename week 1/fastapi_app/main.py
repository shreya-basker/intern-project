from fastapi import FastAPI,status,HTTPException,Response,Depends, Header , Request
...
async def request_validation_error(request: Request, exc : RequestValiationError):
    errors= exc.errors()
    return JSONResponse(
        status_code = 422,
        content = {
