...
from week4.app.rbac import Role, can
from week4.app.security import decode_access_token
...
def assert_owner_or_admin(resource_owner_id: int, current_user) -> None:
    """
